...
public partial class Transaction_RentalOrder : System.Web.UI.Page
{
    SqlConnection conn;
    SqlCommand cmd;
    SqlDataReader dr;
    ...
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Transaction/RentalOrderProcess.aspx?mode=add");
    }
    ...
    protected void loadGrid()
    {
        ...
        {
            sql.Length = 0;
            sql.Append("SELECT a.trans_no, a.trans_date, a.sold_to, c.customer_name AS sold_to_name, a.quot_trans_no, ");
            ...
            sql.Append("a.cust_po_no, a.cust_po_date, a.installation_date, a.status, a.created_date, a.total_amount, a.note ");
            ...
            if (txtSearch.Text.Trim().Replace("'", "`") != "") {
                sql.Append("AND (a.trans_no LIKE '%" + txtSearch.Text + "%' OR a.quot_trans_no LIKE '%" + txtSearch.Text + "%' OR a.sold_to LIKE '%" + txtSearch.Text + "%' OR c.customer_name LIKE '%" + txtSearch.Text + "%' ");
                sql.Append("OR a.bill_to LIKE '%" + txtSearch.Text + "%' OR d.alias_name LIKE '%" + txtSearch.Text + "%' ");
                sql.Append("OR a.ship_to LIKE '%" + txtSearch.Text + "%' OR e.alias_name LIKE '%" + txtSearch.Text + "%' OR e.alias_name_full LIKE '%" + txtSearch.Text + "%' ");
                sql.Append("OR a.cust_po_no LIKE '%" + txtSearch.Text + "%' OR f.description LIKE '%" + txtSearch.Text + "%' OR a.note LIKE '%" + txtSearch.Text + "%') ");
            }
    ...
    protected void imgEdit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Transaction/RentalOrderProcess.aspx?mode=edit&trans_no=" + lblTransNo.Text + "");
    }
