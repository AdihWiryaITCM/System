<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PurchaseRequisitionList.aspx.cs" Inherits="Transaction_PermintaanPembelianBarangList" %>
        ...
        <asp:UpdatePanel runat="server" ID="upSearch" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="form-inline">
                    <div class="row">
                        <div class="col-sm-12">
                            <asp:LinkButton ID="btnAddNew2" ForeColor="White" runat="server" Text="Add New" CssClass="btn btn-primary btn-sm" OnClick="btnAddNew_Click"><i class="fa fa-plus"></i>&nbsp;Add New</asp:LinkButton>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div style="float: left;">
                                Status
                            <asp:DropDownList ID="ddlFilter" Width="110px" runat="server" CssClass="form-control" AutoPostBack="true">
                                ...
                                <div style="float: right;">
                                    <div class="input-group">
                                        <asp:TextBox ID="txtSearch" runat="server" placeholder="Search"
                                            CssClass="form-control" value="" Width="200px" />
                                        <div class="input-group-addon input-group-addon1">
                                            <asp:LinkButton ID="imgSearch" runat="server"><i class="fa fa-search"></i></asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                            </asp:Panel>
                            ...
                            <asp:GridView ID="grid" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ship To" HeaderStyle-CssClass="text-center">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblShipTo" runat="server" Text='<%# Bind("wh_description") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
