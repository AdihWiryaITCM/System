    ...
    <div class="x_panel">
        <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:Panel ID="pMovementType" Visible="false" runat="server" DefaultButton="bSearchMovementType">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-inline">
                                        <asp:Panel ID="pSearchMovementType" runat="server" DefaultButton="bSearchMovementType">
                                            <asp:TextBox ID="tbMovementType" Text="101" runat="server" Width="70px" CssClass="form-control text-uppercase" />
                                            <asp:LinkButton ID="lbMovementType" runat="server" Text="Goods receipt for purchase order" OnClick="lbMovementType_Click" CssClass="alert-link" />
