<%@ Page Title="CMSystem || Inbound Delivery" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InboundDelivery.aspx.cs" Inherits="Transaction_InboundDelivery" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Reff" HeaderStyle-CssClass="text-center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblReff" runat="server" Text='<%# Bind("reff") %>' /><br />
                                            <asp:Label ID="lblMovementTypeName" runat="server" Text='<%# Bind("movement_type_name") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Destination" HeaderStyle-CssClass="text-center">
                                        <ItemStyle HorizontalAlign="Left"  VerticalAlign="Top" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblShipToName" runat="server" Text='<%# Bind("wh_description") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
