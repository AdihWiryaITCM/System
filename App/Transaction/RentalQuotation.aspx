<%@ Page Title="CMSystem || Rental Quotation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RentalQuotation.aspx.cs" Inherits="Transaction_RentalQuotation" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                    <div class="row">
                        ...
                        <%--<asp:Button ID="btnPosting" runat="server" Width="80px" Text="Posting" CssClass="button" OnClick="btnPosting_Click" />--%>
                        </div>
                    </div>
            </ContentTemplate>
        </asp:UpdatePanel>
                            ...
                            <asp:GridView ID="grid" runat="server" Width="100%" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Customer" HeaderStyle-CssClass="text-center">
                                        <ItemStyle HorizontalAlign="Left" Width="185px" VerticalAlign="Top"/>
                                        <ItemTemplate>
